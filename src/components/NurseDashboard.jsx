                ...
                <div class="md:flex no-wrap md:-mx-2  ">
                    ...
                    <div class="w-full mx-2   md:block lg:block md:-mt-24 sm:mt-0">
                        ...
                        <ul class="flex bg-white ">
                            ...
                            <li class="mr-1">
                              <a class="rounded-sm bg-white inline-block py-2 px-4 border-l border-t border-r rounded-t py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#">Doctor</a>
                            </li>
                            <li class="mr-1">
